...
- Each event MUST include an imageSearchQuery: a short Wikimedia Commons file-search query for THIS beat's visual. 2-4 words. The subject must be a CONCRETE, DEPICTABLE thing a period artist or photographer actually stood in front of and captured — and it should reflect THIS beat's own specific scene (its place, its setting, its concrete subject), NOT just the campaign's generic topic. PREFER the specific over the generic: if the beat happens at a particular place or around a particular object/scene that period sources would have depicted, query THAT scene rather than collapsing to the broad campaign subject. The concrete subject can be a NAMED thing (a named battle, person, place/fort/ship, treaty, or dated event) OR a concrete SCENE built from place + setting + subject (e.g. a winter forest with soldiers, a canal under construction with laborers, a farm with machinery buried in dust). Optionally add a year (e.g. "1813") or a one-word medium (e.g. "engraving", "lithograph", "painting", "photograph"). THE TEST: could a camera or an artist have physically stood in front of this exact scene and captured it? If the query's head noun is instead an abstract concept, a feeling, a social process, or a logistical category, Commons holds only BOOKS about it, not images — rewrite it around the concrete scene, or the nearest named depictable subject, that this beat is set in. Do NOT write descriptive sentences. Do NOT use abstract action verbs or emotions (e.g. "fighting", "marching", "suffering", "struggling", "writing", "supplying") — a verb or a feeling is not a scene. Do NOT make the head noun an abstraction (e.g. "impressment", "naval power", "supply", "morale"). The principle: a concrete SCENE the camera or artist could have stood in front of is GOOD; an abstract verb or emotion is BAD. If no concrete depictable subject honestly fits this beat, emit no imageSearchQuery at all — an imageless event falls back cleanly to the campaign backdrop, which beats forcing a disconnected or abstract image. Examples of GOOD queries (concrete, beat-specific, archive-matchable): "Ardennes forest winter soldiers", "Erie Canal construction workers", "Dust Bowl farm buried machinery", "Battle of Lake Erie 1813", "Burning of Washington 1814", "DeWitt Clinton portrait". Examples of BAD queries: "soldiers fighting" (abstract action, not a scene), "workers suffering" (emotion, not a depictable subject), "family struggling" (abstraction → book scans), "Royal Navy impressment 1812" (abstract concept → book scans, not a depicted scene), "Travis writing letter Alamo defenders" (descriptive sentence + verb → matches book titles).
