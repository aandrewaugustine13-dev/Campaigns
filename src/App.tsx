...
},
{
  ...
  trivia: [
    "Thousands of homesteads were abandoned after the Civil War as families headed west or never returned from battle.",
    "Root cellars kept food cool and safe from prairie fires. A well-stocked cellar could mean the difference between life and starvation on the trail.",
  ],
  sageAdvice: [
    { name: "Henrietta Price", role: "Frontier Settler", line: "That cellar door bein' shut tight means whoever left was in a hurry — or somethin' chased them off. Be careful." },
  ],
  attempts: [
    {
      id: "homestead_1",
