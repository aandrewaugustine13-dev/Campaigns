...
{id:"good_grass",phase_min:0.1,phase_max:0.8,weight:3,title:"Paradise Valley",text:"Your scout finds rich grass and clean water. Resting helps herd health but costs precious days.",choices:[{text:"Two days\u2019 rest.",effects:{herdCondition:10,morale:6,supplies:-5,horses:2},result:"The closest thing to heaven. Nobody\u2019s miserable."},{text:"One day.",effects:{herdCondition:5,morale:3,supplies:-3},result:"Enough to take the edge off."},{text:"Keep moving.",outcomes:[{weight:5,effects:{morale:-6,herdCondition:-2},result:"Crew watches it slide past. Some weep."},{weight:5,effects:{morale:-3,herdCondition:-1},result:"An hour later there\u2019s a crossing and they forget."}]}]},
