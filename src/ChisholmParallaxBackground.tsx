          ...
          <div className="absolute bottom-[18%] left-[-25%] chisholm-actor-move" style={{ ["--actor-duration" as string]: "58s" }}>
            <div
              ...
              style={{
                ...
                ["--frame-width" as string]: "96px",
                ["--frame-height" as string]: "96px",
                ["--display-scale" as string]: "1.9",
